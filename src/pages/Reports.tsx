...
import { summarizeReport, analyzeReport } from '../services/aiService';
...
export default function Reports() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          {user?.role === 'ORG_ADMIN' && (
            <button 
              ...
              className="flex items-center justify-center gap-2 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 px-6 py-3 rounded-xl font-semibold border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all shadow-sm"
            >
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-indigo-600 text-white">
              <h2 className="text-xl font-bold">{isEditing ? 'Edit & Resubmit Report' : 'Create New Report'}</h2>
      ...
      {selectedReport && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-900 w-full max-w-4xl rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 flex flex-col max-h-[90vh]">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 mt-1">
                    <p className="text-xs text-slate-500 dark:text-slate-400">Submitted on {format(new Date(selectedReport.createdAt), 'PPPP')}</p>
                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {selectedReport.attachments.map((file) => (
                        <div key={file.id} className="p-4 border border-slate-100 dark:border-slate-800 rounded-2xl flex items-center gap-4 group hover:border-indigo-200 dark:hover:border-indigo-800 transition-all">
