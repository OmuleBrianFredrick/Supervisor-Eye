...
import { ShieldCheck, Building2, Users, ArrowRight, Check, Mail, Lock, User } from 'lucide-react';
        ...
        {step === 2 && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <button
                onClick={() => { setOrgAction('join'); setStep(3); }}
                className="p-6 border-2 border-slate-100 dark:border-slate-800 rounded-2xl hover:border-indigo-600 dark:hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-all text-left group"
              >
                <div className="w-12 h-12 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-xl flex items-center justify-center mb-4 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
              ...
              <button
                onClick={() => { setOrgAction('create'); setStep(3); }}
                className="p-6 border-2 border-slate-100 dark:border-slate-800 rounded-2xl hover:border-indigo-600 dark:hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-all text-left group"
              >
